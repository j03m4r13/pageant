...
<div id='menu' style='float:left;height:50px;padding-top:10px'>
<span><font color='white'>Welcome</font>&nbsp;<font color='red'><?php echo $judgename ?></font></span>&nbsp;<span><a href='/pageant/index.php/judge_page/list_contestants/<?php echo $judge_id;?>'  class='button-link-menu'>Candidates List</a>&nbsp;<a href='/pageant/index.php/judge_page/list_top3/<?php echo $judge_id;?>'  class='button-link-menu'>List Top 3</a>&nbsp;<a href='/pageant/index.php/judge_page/logout'  class='button-link-menu'>Logout</a></span>&nbsp;
</div>
<?php } ?>
